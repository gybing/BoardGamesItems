...
@interface BBKOpinionViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic,copy) NSString * note;
@property (nonatomic,copy) NSString * email;
@end
@implementation BBKOpinionViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    @weakify(self);
    if (indexPath.section == 0) {
        BBFillContantTableViewCell* cell = [BBFillContantTableViewCell cellWithTableView:tableView];
