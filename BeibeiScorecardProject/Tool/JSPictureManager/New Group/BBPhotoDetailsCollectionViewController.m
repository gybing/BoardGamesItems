...
@interface BBPhotoDetailsCollectionViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UIAlertViewDelegate>
@property (nonatomic, strong) NSMutableArray * imageArray;
@property (nonatomic, strong) NSMutableArray * imageArr;
@property (nonatomic, strong) UIButton * selectBtn;
@property (nonatomic, assign) NSInteger index;
@end
@implementation BBPhotoDetailsCollectionViewController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[BBPhotoDetailsCollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    BBPhotoDetailsCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
