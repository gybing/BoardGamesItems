...
@interface KKRootTabBarViewController ()<UITabBarControllerDelegate>

@property(strong,nonatomic) GamesViewController * gamesViewControl;

@property(strong,nonatomic) KKMineViewController * mineViewControl;

@end

@implementation KKRootTabBarViewController
...
{
    static KKRootTabBarViewController* rootTabbar = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        rootTabbar = [KKRootTabBarViewController new];
    });
    return rootTabbar;
}
...
-(KKMineViewController*)mineViewControl
{
    if(_mineViewControl==nil){
        _mineViewControl = [KKMineViewController new];
