...
-(void)cusotmHeaderView
{
    ...
    imageBG.image=[UIImage imageNamed:@"background_image"];
...
-(void)setUpHeaderImage{
    KPersonViewController * personVC = [[KPersonViewController alloc]init];
...
{
    KKMineTableViewCell * cell = [KKMineTableViewCell cellWithTableView:tableView];
...
{
    if (indexPath.section == 0) {
        KOpinionViewController * opinionVC = [[KOpinionViewController alloc]init];
        ...
        KKAboutMineViewController * aboutMineVC = [[KKAboutMineViewController alloc]init];
