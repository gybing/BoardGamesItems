...
@interface KPersonViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation KPersonViewController
...
{
    KKPersonalTableViewCell* cell = [KKPersonalTableViewCell cellWithTableView:tableView];
