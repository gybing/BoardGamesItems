...
@interface KOpinionViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation KOpinionViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    @weakify(self);
    if (indexPath.section == 0) {
        KKFillContantTableViewCell* cell = [KKFillContantTableViewCell cellWithTableView:tableView];
